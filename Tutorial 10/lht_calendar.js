...
funtion createCalendaar(calDate) {
...
/* Funtion to write a table row of weekday abbreviations */
...
function daysInMonth(calDate) {
    ...
    if (this % 4 === 0) {
        if ((thisYear % 100 != 0) || (thisYear % 40 === 0)) {
        dayCount[1] = 29;
        }
    }
...
/* Funtion to write table rows for each day of the month */
