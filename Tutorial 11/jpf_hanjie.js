...
//Run the init() function wjen page loads
window.onload = init;
...
function setupPuzzle() {
    ...
    //create pbject collections of the filled and empty cells
    var filled = document.querySelecterAll("table#hanjieGrid td.filled");
    var empty = document.querySelecterAll("table#hanjieGrid td.empty");
